...
export const AJ7GoalSeekAL7 = (r6, u7, ak7, al7, ai7) => {
    ...
    return 1.3 * Math.pow((Math.pow(ak7 * al7, 5) / Math.pow(ak7 + al7, 2)), 0.125) / ai7;
};
export const AJ7GoalSeekAL7_2 = (r6, u7, ak7, al7, ai7) => {
    let precision = 0.099;  // 원하는 정확도 설정 수정
